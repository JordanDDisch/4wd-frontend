 ...
 * 
 */
(window.webpackJsonp=window.webpackJsonp||[]).push([[1],{bdgK:function(e,t,n){"use strict"
...
return this.broadcastWidth=e.width,this.broadcastHeight=e.height,e},ResizeObservation}(),d=function d(e,t){var n=function createReadOnlyRect(e){var t=e.x,n=e.y,r=e.width,i=e.height,o="undefined"!=typeof DOMRectReadOnly?DOMRectReadOnly:Object,s=Object.create(o.prototype)
return defineConfigurable(s,{x:t,y:n,width:r,height:i,top:n,right:t+r,bottom:i+n,left:t}),s}(t)
defineConfigurable(this,{target:e,contentRect:n})},l=function(){function ResizeObserverSPI(e,t,r){if(this.activeObservations_=[],this.observations_=new n,"function"!=typeof e)throw new TypeError("The callback provided as parameter 1 is not a function.")
...
this.clearActive(),this.observations_.forEach((function(t){t.isActive()&&e.activeObservations_.push(t)}))},ResizeObserverSPI.prototype.broadcastActive=function(){if(this.hasActive()){var e=this.callbackCtx_,t=this.activeObservations_.map((function(e){return new d(e.target,e.broadcastRect())}))
...
var t=a.getInstance(),n=new l(e,t,this)
